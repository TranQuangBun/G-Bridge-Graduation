...
// TODO: Backend chưa có API cho job alerts, sẽ cập nhật khi có API
// Mock data for job alerts (fallback)
...
const INTERPRETER_SIDEBAR_MENU = [
  ...
  { id: "alerts", icon: FaBell, labelKey: "alerts", active: true },
  { id: "profile", icon: FaUser, labelKey: "profile", active: false },
  { id: "settings", icon: FaCog, labelKey: "settings", active: false },
];

// Sidebar menu for Client/Company role (JobAlerts not available for clients)
...
function JobAlertsPage() {
  ...
  // Redirect client users away from JobAlerts page
  useEffect(() => {
    if (user?.role === "client") {
          ...
          <section className={styles.alertsSection}>
            {filteredAlerts.length > 0 ? (
              ...
              <div className={styles.emptyState}>
                <span className={styles.emptyIcon}><FaBell /></span>
