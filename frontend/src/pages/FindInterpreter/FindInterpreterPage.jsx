...
const FindInterpreterPage = () => {
  ...
  useEffect(() => {
    ...
    filters.sortOrder,
    filters.search,
    JSON.stringify(filters.languages), // Stringify array to detect changes
    filters.minRate,
    filters.maxRate,
    filters.minExperience,
    filters.rating,
    filters.location,
    JSON.stringify(filters.specializations), // Stringify array to detect changes
    user,
  ]);
  ...
  const handleLanguageToggle = (lang) => {
    console.log(`🗣️ Toggle language: ${lang}`);
